    ...
    <div>
        <div class="card">
            <div class="card-header">
                ...
                /
                <span class="text-secondary">Edit Category</span>
            </div>
            <div class="card-body">
                <div v-if="ifReady">
                    <form v-on:submit.prevent="updateCategory()">
                        ...
                        <button type="submit" class="btn btn-success btn-sm"><i class="fas fa-edit"></i>&nbsp; Update Category</button>
                    </form>
                </div>
                <div v-else>
                    <div class="progress">
    ...
    export default {
        ...
        methods: {
            updateCategory() {
                ...
                axios.post('/api/categories/' + this.$route.params.id, formData).then(res => {
                    this.$router.push({
