        ...
        <div class="card">
            <div class="card-header clearfix">
                <div class="float-left">
                    ...
                    /
                    <span class="text-secondary">View Categories</span>
                </div>
                <div class="float-right">
                    <router-link class="btn btn-success btn-sm" :to="{ name: 'categories.create' }"><i class="fas fa-plus"></i>&nbsp; Create New Category</router-link>
                </div>
            </div>
            <div class="card-body">
                <table class="table table-hover table-sm">
                    ...
                    <tbody v-if="categories">
                        <tr v-for="{ id, name, description } in categories">
                            ...
                            <td>{{ description }}</td>
                            <td>
                                <router-link class="text-secondary" :to="{ name: 'categories.view', params: { id: id } }">
                                    <i class="fas fa-envelope-open-text"></i> View
                                </router-link>
                                |
                                <router-link class="text-secondary" :to="{ name: 'categories.edit', params: { id: id }}">
    ...
    export default {
        ...
        beforeRouteEnter (to, from, next) {
            if (to.query.per_page == null) {
                getCategories(to.query.page, 10, to.query.searchColumnName, to.query.searchColumnDescription, to.query.order_by, (err, data) => {
