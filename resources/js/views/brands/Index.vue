        ...
        <div class="card">
            <div class="card-header clearfix">
                <div class="float-left">
                    ...
                    /
                    <span class="text-secondary">View Brands</span>
                </div>
                <div class="float-right">
                    <router-link class="btn btn-success btn-sm" :to="{ name: 'brands.create' }"><i class="fas fa-plus"></i>&nbsp; Create New Brand</router-link>
                </div>
            </div>
            <div class="card-body">
                <table class="table table-hover table-sm">
                    <caption>
                        <div class="row">
                            <div class="col-md-9">
                                List of Brands - Total Items {{ this.meta.total }}
                            </div>
                            <div class="col-md-3">
                    ...
                    <tbody v-if="brands">
                        <tr v-for="{ id, name, description } in brands">
                            <td>{{ name }}</td>
                            <td>{{ description }}</td>
                            <td>
                                <router-link class="text-secondary" :to="{ name: 'brands.view', params: { id: id } }">
                                    <i class="fas fa-envelope-open-text"></i> View
                                </router-link>
                                |
                                <router-link class="text-secondary" :to="{ name: 'brands.edit', params: { id: id }}">
        ...
        <div class="clearfix">
            ...
            <div class="float-right">
                <form class="form-inline">
                    <button type="button" class="btn btn-primary mr-2" @click.prevent.default="openSearchModal()">Search Brands</button>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Search Brands</h5>
...
<script>
    const getbrands = (page, per_page, searchColumnName, searchColumnDescription, order_by, callback) => {
        const params = { page, per_page, searchColumnName, searchColumnDescription, order_by };

        axios.get('/api/brands', { params }).then(res => {
    ...
    export default {
        ...
        beforeRouteEnter (to, from, next) {
            if (to.query.per_page == null) {
                getbrands(to.query.page, 10, to.query.searchColumnName, to.query.searchColumnDescription, to.query.order_by, (err, data) => {
                    next(vm => vm.setData(err, data));
                });
            } else {
                getbrands(to.query.page, to.query.per_page, to.query.searchColumnName, to.query.searchColumnDescription, to.query.order_by, (err, data) => {
                    next(vm => vm.setData(err, data));
                });
            }
        },
        ...
        beforeRouteUpdate (to, from, next) {
            getbrands(to.query.page, this.meta.per_page, this.searchColumnName, this.searchColumnDescription, this.order_by, (err, data) => {
        ...
        methods: {
            ...
            setData(err, { data: brands, links, meta }) {
                this.pageNumbers = [];
