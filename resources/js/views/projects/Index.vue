        ...
        <div class="card">
            <div class="card-header clearfix">
                <div class="float-left">
                    ...
                    /
                    <span class="text-secondary">View Projects</span>
                </div>
                <div class="float-right">
                    <router-link class="btn btn-success btn-sm" :to="{ name: 'projects.create' }"><i class="fas fa-plus"></i>&nbsp; Create New Project</router-link>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <tbody v-if="projects">
                        <tr v-for="{ id, name, description } in projects">
                            ...
                            <td>
                                ...
                                |
                                <router-link class="text-secondary" :to="{ name: 'projects.edit', params: { id: id }}">
        ...
        <div class="clearfix">
            ...
            <div class="float-right">
                <form class="form-inline">
                    <button type="button" class="btn btn-primary mr-2" @click.prevent.default="openSearchModal()">Search projects</button>
            ...
            <div class="modal fade" id="searchModal" tabindex="-1" role="dialog" aria-labelledby="filterprojects" aria-hidden="true">
